...
namespace ProductImageFactory.Tests {
    public class CacheHelperTests {
        [Fact]
        public void ExtractCacheObject_AfterExpiry_ThrowsCacheExpiredException()
        {
            var stubKey = "Key1";
        ...
        [Fact]
        public void ExtractCacheObject_BeforeExpiry_ReturnsValidCacheObject() {
            var stubKey = "Key1";
        ...
        [Fact]
        public void ExtractCacheObject_AtExpiry_ThrowsCacheExpiredException() {
            var stubKey = "Key1";
